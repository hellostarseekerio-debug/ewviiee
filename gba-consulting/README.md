...
- **Bilingual engine** — a magnetic 繁/EN toggle; all strings live in a structured resource object (`src/i18n/translations.js`). The Chinese copy is written to Hong Kong business register (港式商務繁體), not machine-translated.
